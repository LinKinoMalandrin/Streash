...
public class Console {
	...
	public void computeCommand() throws TooFewArgumentsException, TooManyArgumentsException,
			UnknownVariableNameExcpetion, SyntaxErrorException, UnknownArgumentException {
	...
	private void reverseScanner() throws TooFewArgumentsException, SyntaxErrorException {
	...
	private String reverseLambda(String first) throws TooFewArgumentsException, SyntaxErrorException {
	...
	public Value evaluateCommand() throws UnknownVariableNameExcpetion, SyntaxErrorException {
		...
		if (e == null)
			throw new UnknownVariableNameExcpetion(expr);
	...
	private Expression getExpression(String name) throws UnknownVariableNameExcpetion, SyntaxErrorException {
	...
	private LambdaVar parseLambda(String first) throws UnknownVariableNameExcpetion, SyntaxErrorException {
		...
		while (command.hasNext()) {
			...
			if (e == null)
				throw new UnknownVariableNameExcpetion(next);
	...
	public Value evaluateFunction(Function f) throws UnknownVariableNameExcpetion, SyntaxErrorException {
	...
	public void computeMetaCommand(String name) throws TooFewArgumentsException, TooManyArgumentsException,
			UnknownVariableNameExcpetion, UnknownArgumentException {
		if (name.equals("/printvar")) {
			printVar();
			return;
		}
	...
	public void printVar() throws UnknownVariableNameExcpetion {
		...
		if (var.split(" ").length > 1)
			throw new IllegalArgumentException("Too many arguents for command printvar");

		Value v = vars.get(var);
		if (v == null)
			throw new UnknownVariableNameExcpetion(var);
	...
	private void notation() throws TooFewArgumentsException, TooManyArgumentsException {

		if (!(command.hasNext())) {
			throw new TooFewArgumentsException("function notation");
		}

		String arg = command.next();
		if (command.hasNext())
			throw new TooManyArgumentsException("function notation");
	...
	private void quit() {
		if (command.hasNext())
			throw new TooFewArgumentsException("function quit");
		System.exit(0);
	}
	...
	public static void main(String[] args)
			throws TooFewArgumentsException, TooManyArgumentsException, UnknownVariableNameExcpetion,
			SyntaxErrorException, IllegalTypesException, UnknowOperatorException, UnknownArgumentException {
